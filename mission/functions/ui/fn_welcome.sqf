...
Description:
	Creates a welcome ui with information about the mission and optional/embedded mods
...
private _text = [
	...
	"",
	"<t size='1.2'>CDLC Support</t>",
	"This mission supports the following CDLCs:",
	format["%1",["S.O.G. Prairie Fire","https://store.steampowered.com/app/1227700/Arma_3_Creator_DLC_SOG_Prairie_Fire/"] call _linkText],
	"",
	"<t size='1.2'>Mod Support</t>",
	"This mission supports the following map, uniform and weapon mods:",
	format["%1 (Equipment and Weapons)",["3CB","https://steamcommunity.com/workshop/filedetails/?id=909680404"] call _linkText],
	format["%1",["Chernarus 2020","https://steamcommunity.com/sharedfiles/filedetails/?id=1981964169"] call _linkText],
	format["%1",["Chernarus Redux","https://steamcommunity.com/sharedfiles/filedetails/?id=1128256978"] call _linkText],
	...
	format["%1 (AFRF, GREF, PKL, SAF and USAF)",["RHS","https://steamcommunity.com/workshop/filedetails/?id=843770737"] call _linkText],
